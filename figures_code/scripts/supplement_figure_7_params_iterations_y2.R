...
#======================================================================================#
library(vioplot)
pdf('../output/FigureS07_param_iterations_y_2.pdf',width=6.5,height=9.5)

layout(matrix(1:11))
par(oma=c(4,6,0.5,0.1),mar=rep(0,4))

p = readRDS('./particles_01.RDS')
e = data.frame(y2000=p$y_2_01)
...
mtext('y_2_01',2,line=4.5)

p = readRDS('./particles_02.RDS')
e = data.frame(y2000=p$y_2_02)
p = readRDS('./particles_03.RDS')
e$y2002 = p$y_2_02
p = readRDS('./particles_04.RDS')
e$y2003 = p$y_2_02
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_02',2,line=4.5)

p = readRDS('./particles_03.RDS')
e = data.frame(y2000=p$y_2_03)
p = readRDS('./particles_04.RDS')
e$y2003 = p$y_2_03
p = readRDS('./particles_05.RDS')
e$y2004 = p$y_2_03
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_03',2,line=4.5)

p = readRDS('./particles_04.RDS')
e = data.frame(y2000=p$y_2_04)
p = readRDS('./particles_05.RDS')
e$y2004 = p$y_2_04
p = readRDS('./particles_06.RDS')
e$y2005 = p$y_2_04
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_04',2,line=4.5)

p = readRDS('./particles_05.RDS')
e = data.frame(y2000=p$y_2_05)
p = readRDS('./particles_06.RDS')
e$y2005 = p$y_2_05
p = readRDS('./particles_07.RDS')
e$y2006 = p$y_2_05
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_05',2,line=4.5)

p = readRDS('./particles_06.RDS')
e = data.frame(y2000=p$y_2_06)
p = readRDS('./particles_07.RDS')
e$y2006 = p$y_2_06
p = readRDS('./particles_08.RDS')
e$y2007 = p$y_2_06
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_06',2,line=4.5)

p = readRDS('./particles_07.RDS')
e = data.frame(y2000=p$y_2_07)
p = readRDS('./particles_08.RDS')
e$y2007 = p$y_2_07
p = readRDS('./particles_09.RDS')
e$y2008 = p$y_2_07
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_07',2,line=4.5)

p = readRDS('./particles_08.RDS')
e = data.frame(y2000=p$y_2_08)
p = readRDS('./particles_09.RDS')
e$y2008 = p$y_2_08
p = readRDS('./particles_10.RDS')
e$y2009 = p$y_2_08
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_08',2,line=4.5)

p = readRDS('./particles_09.RDS')
e = data.frame(y2000=p$y_2_09)
p = readRDS('./particles_10.RDS')
e$y2009 = p$y_2_09
p = readRDS('./particles_11.RDS')
e$y2010 = p$y_2_09
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_09',2,line=4.5)

p = readRDS('./particles_10.RDS')
e = data.frame(y2000=p$y_2_10)
p = readRDS('./particles_11.RDS')
e$y2010 = p$y_2_10
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$y_2_10
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_2_10',2,line=4.5)

p = readRDS('./particles_11.RDS')
e = data.frame(y2000=p$y_2_11)
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$y_2_11
p = readRDS('./particles_final_11_1.RDS')
e$y2011b = p$y_2_11
