...
#======================================================================================#
library(vioplot)
pdf('../output/FigureS08_param_iterations_y_3.pdf',width=6.5,height=6.5)

layout(matrix(1:6))
par(oma=c(4,6,0.5,0.1),mar=rep(0,4))

p = readRDS('./particles_03.RDS')
e = data.frame(y2000=p$y_3_03)
...
mtext('y_3_03',2,line=4.5)

p = readRDS('./particles_05.RDS')
e = data.frame(y2000=p$y_3_05)
p = readRDS('./particles_06.RDS')
e$y2005 = p$y_3_05
p = readRDS('./particles_07.RDS')
e$y2006 = p$y_3_05
...
vioplot(
  ...
  e$y2007,e$y2008,e$y2009,e$y2010,e$y2011a,e$y2011b,e$y2011c,
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_3_05',2,line=4.5)

p = readRDS('./particles_08.RDS')
e = data.frame(y2000=p$y_3_08)
p = readRDS('./particles_09.RDS')
e$y2008 = p$y_3_08
p = readRDS('./particles_10.RDS')
e$y2009 = p$y_3_08
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_3_08',2,line=4.5)

p = readRDS('./particles_09.RDS')
e = data.frame(y2000=p$y_3_09)
p = readRDS('./particles_10.RDS')
e$y2009 = p$y_3_09
p = readRDS('./particles_11.RDS')
e$y2010 = p$y_3_09
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_3_09',2,line=4.5)

p = readRDS('./particles_10.RDS')
e = data.frame(y2000=p$y_3_10)
p = readRDS('./particles_11.RDS')
e$y2010 = p$y_3_10
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$y_3_10
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('y_3_10',2,line=4.5)

p = readRDS('./particles_11.RDS')
e = data.frame(y2000=p$y_3_11)
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$y_3_11
p = readRDS('./particles_final_11_1.RDS')
e$y2011b = p$y_3_11
