...
#======================================================================================#
library(vioplot)
pdf('../output/FigureS05_param_iterations_x_4.pdf',width=6.5,height=4)

layout(matrix(1:3))
par(oma=c(4,4,0.25,0.1),mar=rep(0,4))

p = readRDS('./particles_09.RDS')
e = data.frame(y2000=p$x_4_09)
...
mtext('x_4_09',2,line=2.5)

p = readRDS('./particles_10.RDS')
e = data.frame(y2000=p$x_4_10)
p = readRDS('./particles_11.RDS')
e$y2010 = p$x_4_10
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$x_4_10
...
vioplot(
  ...
  drawRect=F,col=rgb(0,0,1,0.4),add=T)
mtext('x_4_10',2,line=2.5)

p = readRDS('./particles_11.RDS')
e = data.frame(y2000=p$x_4_11)
p = readRDS('./particles_final_11_0.RDS')
e$y2011a = p$x_4_11
p = readRDS('./particles_final_11_1.RDS')
e$y2011b = p$x_4_11
