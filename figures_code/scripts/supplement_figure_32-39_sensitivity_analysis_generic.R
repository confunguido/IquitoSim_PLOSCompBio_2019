...
pdf(file='../output/supplement_figure_S36_sens_generic_bite.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S37_sens_generic_death.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S38_sens_generic_eip.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S39_sens_generic_pmove.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S32_sens_generic_asymp.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S35_sens_generic_mozinfec.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S33_sens_generic_immunity_duration.pdf',width=6.5,height=6.5)
...
pdf(file='../output/supplement_figure_S34_sens_generic_immunity_distribution.pdf',width=6.5,height=6.5)
